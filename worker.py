...
'''
I   initialize Llama LLM
II  create HuggingFace embeddings
'''
def init_llm():
...
'''
I    load pdf
II   split pdf into chunks
III  use Chroma to create embeddings db
IV   build RetrievalQA chain
'''
...
'''
I    query the model with invoke() which includes question + chat history
II   invoke returns the answer
III  update chat history and return answer
'''
